...
#ifndef cxlxdmrpeer_h
#define cxlxdmrpeer_h
...
class CXlxDmrPeer : public CPeer
{
public:
    // constructors
    CXlxDmrPeer();
    CXlxDmrPeer(const CCallsign &, const CIp &, char *, const CVersion &);
    CXlxDmrPeer(const CXlxDmrPeer &);
